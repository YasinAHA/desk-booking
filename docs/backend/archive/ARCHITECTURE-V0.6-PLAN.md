...
- [x] Orden de ejecución acordado: `desks` -> `reservations` -> `auth`.
...
- [x] Completar hardening post-refactor (tipado opaco de transacciones, resultados semánticos, etc.) según `docs/backend/TASKS.md`.
